export default [
	...
	{
		target: '#stream-app-edit-area',
		content: 'In order to receive messages, a Streamsheet has an inbox that you can connect to data streams. As soon as you get your first message, drag and drop the items in the payload onto the sheet. This creates a reference to the stream which updates with every new message. Click the cogwheel to open the inbox settings. This is where you are able to set connected streams and the "Calculation Mode".'
	},
	{
		target: '#stream-app-edit-area',
