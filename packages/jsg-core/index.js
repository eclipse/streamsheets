...
const ChartFormat = require('./src/graph/model/chart/ChartFormat');
const Chart = require('./src/graph/model/chart/Chart');
const ChartTitle = require('./src/graph/model/chart/ChartTitle');
const ChartSeries = require('./src/graph/model/chart/ChartSeries');
const SheetReference = require('./src/graph/expr/SheetReference');

JSG.ChartAxis = ChartAxis;
JSG.ChartRect = ChartRect;
JSG.ChartFormat = ChartFormat;
JSG.Chart = Chart;
JSG.ChartTitle = ChartTitle;
JSG.ChartSeries = ChartSeries;
