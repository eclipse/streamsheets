...
export const STREAM_SET_CONFIG = 'STREAM_SET_CONFIG';
export const STREAM_SAVING_ERROR = 'STREAM_SAVING_ERROR';

export const LICENSE_INFORMATION = 'LICENSE_INFORMATION';

export const STREAMS_RELOAD_REQUEST = 'STREAMS_RELOAD_REQUEST';
export const STREAMS_RELOAD_RESPONSE = 'STREAMS_RELOAD_RESPONSE';
export const STREAMS_RELOAD_ERROR = 'STREAMS_RELOAD_ERROR';
export const FETCH_STREAMS = 'FETCH_STREAMS';
export const RECEIVE_STREAMS = 'RECEIVE_STREAMS';
export const STREAM_INITIAL_SET = 'STREAM_INITIAL_SET';
...
export const FETCH_EXISTING = 'FETCH_EXISTING';
export const RECEIVE_EXISTING = 'RECEIVE_EXISTING';
...
export const SEND_IMPORT_MACHINE_SUCCESS = 'SEND_IMPORT_MACHINE_SUCCESS';
export const SEND_IMPORT_MACHINE_ERROR = 'SEND_IMPORT_MACHINE_ERROR';
export const SEND_IMPORT_SUCCESS = 'SEND_IMPORT_SUCCESS';
export const SEND_IMPORT_ERROR = 'SEND_IMPORT_ERROR';
export const IMPORT_UPDATE_MACHINE_SELECTION = 'IMPORT_UPDATE_MACHINE_SELECTION';
export const IMPORT_UPDATE_STREAM_SELECTION = 'IMPORT_UPDATE_STREAM_SELECTION';
...
export const DS_TOGGLE_PROGRESS = 'DS_TOGGLE_PROGRESS';
