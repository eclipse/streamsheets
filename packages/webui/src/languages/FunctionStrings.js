...
const Strings = {
	...
	'DRAW.ELLIPSE': {
		category: 'drawing',
		en: {
			argumentList: 'UniqueID,Container,Name,X,Y,Width,Height,LineFormat,FillFormat,Attributes,Events,Angle,RotCenter',
	...
	'DRAW.RECTANGLE': {
		category: 'drawing',
		en: {
			argumentList: 'UniqueID,Parent,Name,X,Y,Width,Height,LineFormat,FillFormat,Attributes,Events,Angle,RotCenter',
	...
	LINEFORMAT: {
		...
		de: {
			argumentList: 'Farbe,Stil,Breite,PfeilAnfang,PfeilEnde',
	...
	REQUEST: {
		...
		de: {
			argumentList: 'Stream,ParameterJSON,ZielSheet',
