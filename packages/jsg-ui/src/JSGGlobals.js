...
JSG.init = (jsghome, locale) => {
	...
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_NOTAVAIL}.png`,
		JSG.imagePool.IMG_NOTAVAIL
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_EXPANDED}.png`,
		JSG.imagePool.IMG_EXPANDED
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_COLLAPSED}.png`,
		JSG.imagePool.IMG_COLLAPSED
	);

	JSG.imagePool.add(`${jsghome}/res/images/${JSG.imagePool.IMG_BOLD}.png`, JSG.imagePool.IMG_BOLD);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_ITALIC}.png`,
		JSG.imagePool.IMG_ITALIC
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_UNDERLINE}.png`,
		JSG.imagePool.IMG_UNDERLINE
	);

	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_LEFT_ALIGN}.png`,
		JSG.imagePool.IMG_LEFT_ALIGN
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_CENTER_ALIGN}.png`,
		JSG.imagePool.IMG_CENTER_ALIGN
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_RIGHT_ALIGN}.png`,
		JSG.imagePool.IMG_RIGHT_ALIGN
	);

	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_FONTCOLOR}.png`,
		JSG.imagePool.IMG_FONTCOLOR
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_FONTSIZE_UP}.png`,
		JSG.imagePool.IMG_FONTSIZE_UP
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_FONTSIZE_DOWN}.png`,
		JSG.imagePool.IMG_FONTSIZE_DOWN
	);

	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_BULLETS}.png`,
		JSG.imagePool.IMG_BULLETS
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_NUMBERED}.png`,
		JSG.imagePool.IMG_NUMBERED
	);

	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_TREE_CHECKED}.png`,
		JSG.imagePool.IMG_TREE_CHECKED
	);
	JSG.imagePool.add(
		`${jsghome}/res/images/${JSG.imagePool.IMG_TREE_UNCHECKED}.png`,
		JSG.imagePool.IMG_TREE_UNCHECKED
	);

	// load SVGs
	// JSG.imagePool.add(jsghome + "/res/svg/delete_24px.svg", 'md_delete_forever');
	JSG.imagePool.add(`${jsghome}/res/svg/${JSG.imagePool.SVG_DELETE}.svg`, JSG.imagePool.SVG_DELETE);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_CREATE_EDGE}.svg`,
		JSG.imagePool.SVG_CREATE_EDGE
	);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_CREATE_HVEDGE}.svg`,
		JSG.imagePool.SVG_CREATE_HVEDGE
	);
	JSG.imagePool.add(`${jsghome}/res/svg/${JSG.imagePool.SVG_MOVE_UP}.svg`, JSG.imagePool.SVG_MOVE_UP);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_MOVE_DOWN}.svg`,
		JSG.imagePool.SVG_MOVE_DOWN
	);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_MOVE_LEFT}.svg`,
		JSG.imagePool.SVG_MOVE_LEFT
	);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_MOVE_RIGHT}.svg`,
		JSG.imagePool.SVG_MOVE_RIGHT
	);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_CHECKED}.svg`,
		JSG.imagePool.SVG_CHECKED
	);
	JSG.imagePool.add(
		`${jsghome}/res/svg/${JSG.imagePool.SVG_UNCHECKED}.svg`,
		JSG.imagePool.SVG_UNCHECKED
	);
