module.exports = {
	...
	functions: {
		...
		BIN2OCT: {
			en: { argumentList: 'Number,Places', description: 'Converts a binary number to octal' },
			de: { argumentList: 'Zahl,Stellen', description: 'Konvertiert eine binäre Zahl in eine oktale' }
		},
		DEC2BIN: {
			en: { argumentList: 'Number,Places', description: 'Converts a decimal number to binary' },
			de: { argumentList: 'Zahl,Stellen', description: 'Konvertiert eine dezimale Zahl in eine binäre' }
		},
		DEC2HEX: {
			en: { argumentList: 'Number,Places', description: 'Converts a decimal number to hexadecimal' },
			de: { argumentList: 'Zahl,Stellen', description: 'Konvertiert eine dezimale Zahl in eine hexadezimale' }
		},
		DEC2OCT: {
		...
		HEX2OCT: {
			...
			de: { argumentList: 'Zahl; Stellen', description: 'Konvertiert eine hexadezimale Zahl in eine oktale' }
		},
		OCT2BIN: {
			en: { argumentList: 'Number,Places', description: 'Converts an octal number to binary' },
			de: { argumentList: 'Zahl,Stellen', description: 'Konvertiert eine oktale Zahl in eine binäre' }
		},
		OCT2DEC: {
			en: { argumentList: 'Number', description: 'Converts an octal number to decimal' },
			de: { argumentList: 'Zahl', description: 'Konvertiert eine oktale Zahl in eine dezimale' }
		},
		OCT2HEX: {
			en: { argumentList: 'Number,Places', description: 'Converts an octal number to hexadecimal' },
			de: { argumentList: 'Zahl,Stellen', description: 'Konvertiert eine oktale Zahl in eine hexadezimale' }
		}
	}
};
