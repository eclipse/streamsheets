...
- <https://projects.eclipse.org/projects/iot.streamsheets>
...
1. [Fork the repository on GitHub](https://github.com/eclipse/streamsheets/fork)
2. Clone the forked repository onto your computer: ``` git clone
   https://github.com/<your username>/streamsheets.git ```
...
10. Finally, go to
	[https://github.com/eclipse/streamsheets](https://github.com/eclipse/streamsheets)
...
[mailing list](https://dev.eclipse.org/mailman/listinfo/streamsheets-dev).

Search for bugs:
----------------

This project uses [Github](https://github.com/eclipse/streamsheets/issues)
...
- [Create new Streamsheets bug](https://github.com/eclipse/streamsheets/issues)
