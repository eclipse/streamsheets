...
type nanana<T extends SheetParam> = typeof T;

const f = function<T, U extends {id: T}>(arg: U): T{}

const ff = f({id: 'nanana'} as const)
...
function func2(def: SheetFunction): void {}
