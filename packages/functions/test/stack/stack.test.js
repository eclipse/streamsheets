...
describe('stack functions', () => {
	...
	describe.skip('stack add', () => {
		describe.skip('stack add at bottom', () => {
		...
		describe.skip('stack add at top', () => {
		...
		describe.skip('stack add with drop to target', () => {
		...
		describe.skip('stack add errors', () => {
			// DL-1285
	...
	describe('stack find', () => {
		it.skip('should find a row in stackrange depending on criteriarange', () => {
			// fill stackrange:
			expect(createTerm('stackadd(A10:C12, A1:C3)', sheet).value).toBe(true);
		...
		it.skip('should treat values on same criteriarange row as an AND condition', () => {
			// fill stackrange:
		...
		it.skip('should treat values on different criteriarange rows as an OR condition', () => {
			// fill stackrange:
			expect(createTerm('stackadd(A10:C11, A1:C2)', sheet).value).toBe(true);
			// match:
			expect(createTerm('stackfind(A10:C11, A60:C62)', sheet).value).toBe(true);
		...
		it.skip('should copy matching row from stackrange to target range if set', () => {
			// fill stackrange:
			expect(createTerm('stackadd(A10:C12, A1:C3)', sheet).value).toBe(true);
		...
		it.skip('should drop matching row from stackrange if drop parameter is set', () => {
			// fill stackrange:
		...
		it.skip('should copy dropped matching row to specified target', () => {
			// fill stackrange:
			expect(createTerm('stackadd(A10:C13, A1:C4)', sheet).value).toBe(true);
		...
		describe('unique parameter', () => {			
			it('should copy only first matching row', () => {
				...
				expect(createTerm('stackfind(A70:B79, B70:B71, F70:G79)', sheet).value).toBe(true);
				// check target range:
				expect(sheet.cellAt('F71').value).toBe(STACKRANGE_SHEET.B71);
				expect(sheet.cellAt('G71').value).toBe(STACKRANGE_SHEET.A71);
				expect(sheet.cellAt('F72').value).toBe(STACKRANGE_SHEET.B74);
				expect(sheet.cellAt('G72').value).toBe(STACKRANGE_SHEET.A74);
				expect(sheet.cellAt('F73').value).toBe(STACKRANGE_SHEET.B75);
				expect(sheet.cellAt('G73').value).toBe(STACKRANGE_SHEET.A75);
				expect(sheet.cellAt('F74').value).toBe(STACKRANGE_SHEET.B76);
				expect(sheet.cellAt('G74').value).toBe(STACKRANGE_SHEET.A76);
				expect(sheet.cellAt('F75')).toBeUndefined();
				expect(sheet.cellAt('G75')).toBeUndefined();
				// same now with unique parameter set:
				expect(createTerm('stackfind(A70:B79, B70:B71, F80:G89, , true)', sheet).value).toBe(true);
				// check target range:
				expect(sheet.cellAt('F81').value).toBe(STACKRANGE_SHEET.B71);
				expect(sheet.cellAt('G81').value).toBe(STACKRANGE_SHEET.A71);
				expect(sheet.cellAt('F82').value).toBe(STACKRANGE_SHEET.B75);
				expect(sheet.cellAt('G82').value).toBe(STACKRANGE_SHEET.A75);
				expect(sheet.cellAt('F83')).toBeUndefined();
				expect(sheet.cellAt('G83')).toBeUndefined();
				expect(sheet.cellAt('F84')).toBeUndefined();
				expect(sheet.cellAt('G84')).toBeUndefined();
				// expect(createTerm('stackfind(B10:C14, C1:C2, A80:B83, ,true)', sheet).value).toBe(true);
				// // check target range:
				// expect(sheet.cellAt('A91').value).toBe(STACKRANGE_SHEET.B7);
				// expect(sheet.cellAt('B91').value).toBe(STACKRANGE_SHEET.A7);
				// expect(sheet.cellAt('A92')).toBeUndefined();
				// expect(sheet.cellAt('B92')).toBeUndefined();
			...
			it('should default to false, i.e. has no effect', () => {
			});
		});
	});
	describe.skip('stack rotate', () => {
