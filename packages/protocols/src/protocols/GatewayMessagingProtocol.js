...
module.exports = {
	MESSAGE_TYPES: {
		...
		GET_CELL_RAW_VALUE: MachineServerMessageTypes.GET_CELL_RAW_VALUE,
		...
		MACHINE_ACTION_MESSAGE_TYPE: MachineServerMessageTypes.MACHINE_ACTION_MESSAGE_TYPE,
	...
	EVENTS: {
		...
		MACHINE_CYCLEREGULATED_EVENT: MachineServerEvents.MACHINE_CYCLEREGULATED_EVENT,
